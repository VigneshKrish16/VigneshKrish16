<!-- README.md for VigneshKrish16 (copy-paste into VigneshKrish16/VigneshKrish16/README.md) -->
...
## 🛠 Tech Stack (clean AI-first table)
<!-- HTML table to mimic the image layout. GitHub supports basic HTML in READMEs. -->
<table>
  <tr>
  ...
  <tr>
    <td>
      ...
      <img src="https://img.shields.io/badge/Notebooks-6f42c1?style=for-the-badge&logo=visualstudiocode&logoColor=white" alt="Notebooks"/>
    </td>
    <td>
...
## 🌀 Fun Animations (auto-generated)
> These are generated by GitHub Actions and committed to the repo. If they don't show, run the workflows in **Actions** once.

### 🐍 Contribution Snake (light / dark)
Use `<picture>` so GitHub shows the correct image in light/dark mode:
